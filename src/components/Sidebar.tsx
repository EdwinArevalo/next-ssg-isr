...
import { IoBrowsersOutline, IoCalculator, IoCalendarNumber, IoFootball, IoGameController, IoLogoAngular, IoLogoApple, IoLogoNodejs, IoLogoReact, IoTabletLandscape } from 'react-icons/io5';
...
export const Sidebar = () => {
  return (
    ...
    <div id="menu" 
      style={{ width: '400px' }}
      className="bg-black min-h-screen z-10 text-slate-300 w-64 left-0 overflow-y-scroll">
